 ...
 * 
 */
@WebServiceClient(name = "ConsultaDeLivrosBeanService", targetNamespace = "http://ws.loja.caelum.com.br/", wsdlLocation = "http://localhost:8080/fj31-loja-ejb3/ConsultaDeLivrosBean?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONSULTADELIVROSBEANSERVICE_QNAME = new QName("http://ws.loja.caelum.com.br/", "ConsultaDeLivrosBeanService");
    ...
    public ConsultaDeLivrosBean getConsultaDeLivrosBeanPort() {
        return super.getPort(new QName("http://ws.loja.caelum.com.br/", "ConsultaDeLivrosBeanPort"), ConsultaDeLivrosBean.class);
    }
    ...
    public ConsultaDeLivrosBean getConsultaDeLivrosBeanPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.loja.caelum.com.br/", "ConsultaDeLivrosBeanPort"), ConsultaDeLivrosBean.class, features);
    }
